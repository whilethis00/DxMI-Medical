...
#PBS -o /home/introai26/.agile/user/hsjung/DxMI_Medical/outputs/pbs_logs/v3_seed3.out
#PBS -e /home/introai26/.agile/user/hsjung/DxMI_Medical/outputs/pbs_logs/v3_seed3.err
...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 scripts/train.py \
    --config configs/ebm_fm_gate_v3_s3.yaml \
    --seed 3
